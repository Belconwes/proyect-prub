...
namespace Proyecto_prueba.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(PruebafContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre,Telefono,Descripcion")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre,Telefono,Descripcion")] Proveedore proveedore)
        {
